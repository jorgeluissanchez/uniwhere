...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ref={ref}
      className={cn(
        'bg-muted flex h-14 w-full flex-row items-center justify-between gap-2 rounded-2xl px-4 py-2',
        Platform.select({
            ...
            <NativeOnlyAnimatedView className="z-50" entering={FadeIn} exiting={FadeOut}>
              <SelectPrimitive.Content
                className={cn(
                  ...
                  Platform.select({
                    web: cn(
                      'animate-in fade-in-0 zoom-in-95 [transform-origin:var(--radix-select-content-transform-origin)] max-h-52 overflow-y-auto overflow-x-hidden',
